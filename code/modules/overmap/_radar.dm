...
/obj/machinery/computer/ship/dradis/tgui_data(mob/user) //NEW AND IMPROVED DRADIS 2.0. NOW FEATURING LESS LAG AND CLICKSPAM. ~~This was a pain to code. Don't make me do it again..please? -Kmc~~ 2020 Kmc here, I recoded it. You're right! It was painful, also your code sucked :)
	var/list/data = list()
	...
	for(var/obj/effect/overmap_anomaly/OA in linked?.current_system?.system_contents)
		if(OA && istype(OA) && OA.z == linked?.z)
			blips.Add(list(list("x" = OA.x, "y" = OA.y, "colour" = "#eb9534", "name" = "[(OA) ? OA.name : "anomaly"]", opacity=showAnomalies * 0.01, alignment = "uncharted")))
	...
	if(ship_count > last_ship_count) //Play a tone if ship count changes
		...
		playsound(src, 'sound/effects/ship/contact.ogg', 100, FALSE)
...
/datum/asset/simple/overmap_flight
	assets = list(
		"background.png"	= 'icons/overmap/gui/flight_console/background.png',
		"monitor.png"		= 'icons/overmap/gui/flight_console/monitor.png',
		"brake_off.png"		= 'icons/overmap/gui/flight_console/brake_off.png',
		"brake_on.png"		= 'icons/overmap/gui/flight_console/brake_on.png',
		"flighttoggle.png"		= 'icons/overmap/gui/flight_console/flighttoggle.png',
		"hull0.png"		= 'icons/overmap/gui/flight_console/hull0.png',
		"hull25.png"		= 'icons/overmap/gui/flight_console/hull25.png',
		"hull50.png"		= 'icons/overmap/gui/flight_console/hull50.png',
		"hull75.png"		= 'icons/overmap/gui/flight_console/hull75.png',
		"hull100.png"		= 'icons/overmap/gui/flight_console/hull100.png',
		"rotation_keyboard.png"		= 'icons/overmap/gui/flight_console/rotation_keyboard.png',
		"rotation_mouse.png"		= 'icons/overmap/gui/flight_console/rotation_mouse.png',
		"rotationtoggle.png"		= 'icons/overmap/gui/flight_console/rotationtoggle.png',
		)
