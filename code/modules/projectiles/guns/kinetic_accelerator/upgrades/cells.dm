	...
	if(pump_restore)
		...
		if(stored_charge >= cell_increase)
			...
			if(!pump_delay || do_after(user, pump_delay))
				...
				playsound(src, 'sound/effects/weapons/energy/kinetic_reload.ogg', 50, FALSE)
...
/obj/item/custom_ka_upgrade/cells/cell04/on_update(obj/item/gun/custom_ka/the_gun)
...
/obj/item/custom_ka_upgrade/cells/cell05/on_fire(obj/item/gun/custom_ka/the_gun)
...
/obj/item/custom_ka_upgrade/cells/cyborg/on_update(obj/item/gun/custom_ka/the_gun)
...
/obj/item/custom_ka_upgrade/cells/inertia_charging/on_update(obj/item/gun/custom_ka/the_gun)
