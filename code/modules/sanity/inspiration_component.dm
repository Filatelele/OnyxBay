...
/datum/component/inspiration/register_with_parent()
	register_signal(parent, SIGNAL_EXAMINED_MORE, nameof(.proc/on_examine))
...
/datum/component/inspiration/proc/on_examine(mob/user, list/reference)
	...
	//if(perk)
	//	var/datum/trait/oddity/OD = GLOB.all_perks[perk]
